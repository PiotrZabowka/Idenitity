...
module.exports = {
	...
	"container": "Admin__container___qH4TH"
};
...
exports.default = (0, _aspnetPrerendering.createServerRenderer)(function (params) {
  return new Promise(function (resolve) {
    ...
    var store = (0, _configureStore2.default)(params.data, memoryHistory);
    // Create an enhanced history that syncs navigation events with the store
    (0, _reactRouterRedux.syncHistoryWithStore)(memoryHistory, store);
