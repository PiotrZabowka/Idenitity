...
var _indexReducer = __webpack_require__(53);

var _indexReducer2 = _interopRequireDefault(_indexReducer);

var _indexSagas = __webpack_require__(54);
...
function configureStore(initialState) {
    ...
    if (false) {
        module.hot.accept('./index-reducer', function () {
            var nextRootReducer = require('./index-reducer');
...
var _widgets = __webpack_require__(57);
...
var _aspnetPrerendering = __webpack_require__(48);
...
exports.default = (0, _aspnetPrerendering.createServerRenderer)(function (params) {
    return new Promise(function (resolve, reject) {
        ...
        (0, _reactRouter.match)({ routes: _routes2.default, location: params.location }, function (error, redirectLocation, renderProps) {
            ...
            var result = (0, _server.renderToString)(app);
            console.log(result);
