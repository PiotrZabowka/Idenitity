...
/******/ 	var hotCurrentHash = "a492dd4f5147126ea4a0"; // eslint-disable-line no-unused-vars
...
var history = _reactRouter.browserHistory; //syncHistoryWithStore(browserHistory, store);
...
var _indexReducer = __webpack_require__(106);
...
function configureStore(initialState) {
    ...
    var store = (0, _redux.createStore)(_indexReducer2.default, composeSetup((0, _redux.applyMiddleware)(sagaMiddleware)));
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(61)(Function.call, __webpack_require__(65).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _supportsProtoAssignment = __webpack_require__(94);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(58), __webpack_require__(95)))
